...
def detection_targets_graph(proposals, gt_class_ids, gt_boxes, config):
    ...
    generates target class IDs, bounding box deltas.
    ...
    # Append negative ROIs and pad bbox deltas
...
############################################################
# TODO - Miscellenous Graph Functions
############################################################
